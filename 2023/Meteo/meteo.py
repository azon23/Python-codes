...
win = Tk()
win.title('Météo')
win.iconbitmap(fr"{rel_path}\res\meteo.ico")
win.state('zoomed')
win.minsize(700, 600)
...
cityName_label = Label(upper_main_frame, text=ville, font=fontUpper, bg=bg_color, fg=title_color)
...
background = ImageTk.PhotoImage(Image.open(fr"{rel_path}\res\{moment}.png"))
canvas.create_image(0, 0, image=background, anchor='nw')

icon_code = weather_info['Illustration']
icon_path = fr"{rel_path}\res\illustrations\{icon_code}.png"
...
canvas.create_text(850, 270, text=temps, font=("Roboto", 50), fill=label_color, justify='center')
