...
def run():
    ...
    root.iconbitmap(r"C:\Users\HP\Documents\Files\scripts\Test ressources\ico_bitmap\calculator.ico")
    ...
    image = PhotoImage(file=r"C:\Users\HP\Documents\Files\scripts\Test ressources\icon.png")  # raw string
    ...
    key3.grid(column=2, row=3, padx=2, pady=2, sticky="nsew")
